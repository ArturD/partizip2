...
export const verbs: Verb[] = [
  ...
  ...group('common', [
    ['brauchen', 'gebraucht', 'need', 'weak', false],
    ['leben', 'gelebt', 'live', 'weak', false],
    ['lieben', 'geliebt', 'love', 'weak', false],
    ['reisen', 'gereist', 'travel', 'weak', false],
    ['besuchen', 'besucht', 'visit', 'weak', false],
    ['erzählen', 'erzählt', 'tell / narrate', 'weak', false],
    ['erklären', 'erklärt', 'explain', 'weak', false],
    ['antworten', 'geantwortet', 'answer / reply', 'weak', false],
    ['öffnen', 'geöffnet', 'open', 'weak', false],
    ['kosten', 'gekostet', 'cost', 'weak', false],
    ['bestellen', 'bestellt', 'order', 'weak', false],
    ['zeigen', 'gezeigt', 'show', 'weak', false],
    ['stellen', 'gestellt', 'put / place upright', 'weak', false],
    ['legen', 'gelegt', 'lay / put down', 'weak', false],
    ['holen', 'geholt', 'fetch / get', 'weak', false],
    ['putzen', 'geputzt', 'clean', 'weak', false],
    ['tanzen', 'getanzt', 'dance', 'weak', false],
    ['lachen', 'gelacht', 'laugh', 'weak', false],
    ['aufräumen', 'aufgeräumt', 'tidy up', 'weak', true],
    ['studieren', 'studiert', 'study at university', 'weak', false],
  ]),
  ...group('extended', [
    ['vorbereiten', 'vorbereitet', 'prepare', 'weak', true],
    ['vereinbaren', 'vereinbart', 'agree on / arrange', 'weak', false],
    ['reservieren', 'reserviert', 'reserve / book', 'weak', false],
    ['reparieren', 'repariert', 'repair', 'weak', false],
    ['organisieren', 'organisiert', 'organize', 'weak', false],
    ['diskutieren', 'diskutiert', 'discuss', 'weak', false],
    ['informieren', 'informiert', 'inform', 'weak', false],
    ['probieren', 'probiert', 'try / taste', 'weak', false],
    ['wiederholen', 'wiederholt', 'repeat', 'weak', false],
    ['übersetzen', 'übersetzt', 'translate', 'weak', false],
    ['entschuldigen', 'entschuldigt', 'excuse / forgive', 'weak', false],
    ['entspannen', 'entspannt', 'relax', 'weak', false],
    ['verdienen', 'verdient', 'earn / deserve', 'weak', false],
    ['vermieten', 'vermietet', 'rent out', 'weak', false],
    ['benutzen', 'benutzt', 'use', 'weak', false],
    ['wechseln', 'gewechselt', 'change / switch', 'weak', false],
    ['sammeln', 'gesammelt', 'collect', 'weak', false],
    ['wandern', 'gewandert', 'hike', 'weak', false],
    ['ausfüllen', 'ausgefüllt', 'fill in / fill out', 'weak', true],
    ['anmelden', 'angemeldet', 'register / sign up', 'weak', true],
  ]),
  ...group('extended', [
    ['schwimmen', 'geschwommen', 'swim', 'strong', false],
    ['fliegen', 'geflogen', 'fly', 'strong', false],
    ['singen', 'gesungen', 'sing', 'strong', false],
    ['gewinnen', 'gewonnen', 'win', 'strong', false],
    ['ziehen', 'gezogen', 'pull', 'strong', false],
    ['fallen', 'gefallen', 'fall', 'strong', false],
    ['halten', 'gehalten', 'hold / stop', 'strong', false],
    ['lassen', 'gelassen', 'let / leave', 'strong', false],
    ['waschen', 'gewaschen', 'wash', 'strong', false],
    ['schließen', 'geschlossen', 'close', 'strong', false],
    ['schneiden', 'geschnitten', 'cut', 'strong', false],
    ['beißen', 'gebissen', 'bite', 'strong', false],
    ['bieten', 'geboten', 'offer', 'strong', false],
    ['bitten', 'gebeten', 'ask / request', 'strong', false],
    ['entscheiden', 'entschieden', 'decide', 'strong', false],
    ['empfehlen', 'empfohlen', 'recommend', 'strong', false],
    ['vergleichen', 'verglichen', 'compare', 'strong', false],
    ['unterschreiben', 'unterschrieben', 'sign', 'strong', false],
    ['rennen', 'gerannt', 'run', 'mixed', false],
    ['mitbringen', 'mitgebracht', 'bring along', 'mixed', true],
  ]),
];
